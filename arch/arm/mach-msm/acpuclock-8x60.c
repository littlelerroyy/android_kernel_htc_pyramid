...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	[0]  = { MAX_AXI, 0, 0,    1000000, 1075000, 0},
	[1]  = { 432000,  1, 0x08, 1000000, 1075000, 0},
	[2]  = { 486000,  1, 0x09, 1000000, 1075000, 0},
	[3]  = { 540000,  1, 0x0A, 1000000, 1075000, 0},
	[4]  = { 594000,  1, 0x0B, 1000000, 1075000, 0},
	...
	[20] = {1620000,  1, 0x1E, 1200000, 1250000, 4},
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_oc[] = {
  ...
  { {1, 1}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(20), 1200000, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(20), 1200000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(20), 1230000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(20), 1250000, 0x03006000},
  { {1, 1}, 1890000,  ACPU_SCPLL, 0, 0, 1, 0x23, L2(20), 1300000, 0x03006000},
  { {1, 1}, 1944000,  ACPU_SCPLL, 0, 0, 1, 0x24, L2(20), 1370000, 0x03006000},
  { {0, 0}, 0 },
};
